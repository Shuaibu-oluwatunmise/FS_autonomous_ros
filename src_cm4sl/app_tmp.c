...
static char const *CompileLibs[] = {
    ...
    "libcar4sl.a	CarMaker-Car linux64 14.1.1 2025-07-07",
    "libcarmaker4sl.a	CarMaker linux64 14.1.1 2025-07-07", "libipgdriver.a	IPGDriver linux64 14.1.1 2025-07-04",
    "libipgroad.a	IPGRoad linux64 14.1.1 2025-07-03", "libipgtire.a	IPGTire linux64 9.1.1 2024-10-08",
    NULL};

static char const *CompileFlags[] = {"-m64 -fPIC -O3 -DNDEBUG -DLINUX -DLINUX64 -D_GNU_SOURCE",
    "-D_FILE_OFFSET_BITS=64 -DCM_NUMVER=140101", "-DMYMODELS -Wall -Wimplicit -Wmissing-prototypes",
    "-Wno-array-bounds -Wno-address-of-packed-member", "-fno-stack-protector -Wlogical-op -DCM4SL", "-D_GNU_SOURCE",
    "-I../../../lib/ipc-api/linux64/include -m64", "-fno-strict-aliasing -pthread -fexceptions", NULL};
...
tAppStartInfo AppStartInfo = {
    ...
    "2025-07-07 14:37:25", /* App_CompileTime */
